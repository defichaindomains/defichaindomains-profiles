...
export default function ProfilePage() {
  ...
  const { resolvedAddress, loading: addressLoading } = useDomain(domain);

  const { records, loading: recordsLoading } = useRecords(domain);
  ...
  if (!domain && !resolvedAddress) {
    return (
      <AppContainer>
        <div className=" max-w-[720px] w-3/5 flex flex-col items-center lg:items-center h-full  px-3 py-8 lg:px-8 lg:mt-12 gap-2 lg:gap-0">
  ...
  if (!resolvedAddress && !recordsLoading) {
    return (
      <AppContainer>
        <div className="w-3/5 max-w-[720px] flex flex-col items-center lg:items-center h-full  px-3 py-8 lg:px-8 lg:mt-12 gap-2 lg:gap-0">
  ...
  return (
    <AppContainer>
      <div className="w-3/5 max-w-[720px] flex flex-col items-center lg:items-center h-full  px-3 py-8 lg:px-8 lg:my-12 gap-2 lg:gap-0">
        {recordsLoading ? (
          <Skeleton className="w-[150px] h-[150px] rounded-full" />
        ) : (
          <MediaRenderer
              ...
              <div className="mt-8 flex flex-wrap gap-8 justify-center items-center">
                {records.url && (
                  <Link href={records.url} target="_blank">
                    <Card className="w-52 p-6  hover:shadow-lg transition-shadow duration-200 ease-in-out cursor-pointer bg-gradient-to-br from-gray-100 to-transparent">
                      <Image
                        src={"/web.png"}
                        width={30}
                        height={30}
                ...
                {records["com.reddit"] && (
                  <Link
                    ...
                    target="_blank"
                  >
                    <Card className="w-52 p-6  hover:shadow-lg transition-shadow duration-200 ease-in-out cursor-pointer bg-gradient-to-br from-red-100 to-transparent">
                      <Image
                        src={"/reddit.png"}
                        width={30}
                        height={30}
                ...
                {records["com.twitter"] && (
                  <Link
                    ...
                    target="_blank"
                  >
                    <Card className="w-52 p-6  hover:shadow-lg transition-shadow duration-200 ease-in-out cursor-pointer bg-gradient-to-br from-neutral-100 to-transparent">
                      <Image
                        src={"/x.png"}
                        width={30}
                        height={30}
                ...
                {records["com.telegram"] && (
                  <Link
                    ...
                    target="_blank"
                  >
                    <Card className="w-52 p-6  hover:shadow-lg transition-shadow duration-200 ease-in-out cursor-pointer bg-gradient-to-br from-sky-100 to-transparent">
                      <Image
                        src={"/telegram.png"}
                        width={30}
                        height={30}
                ...
                {records["com.discord"] && (
                  <Link
                    ...
                    target="_blank"
                  >
                    <Card className="w-52 p-6  hover:shadow-lg transition-shadow duration-200 ease-in-out cursor-pointer bg-gradient-to-br from-violet-100 to-transparent">
                      <Image
                        src={"/discord.png"}
                        width={30}
                        height={30}
